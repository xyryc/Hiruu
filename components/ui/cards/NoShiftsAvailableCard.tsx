...
type NoShiftsAvailableCardProps = {
    className?: string;
};

const NoShiftsAvailableCard = ({ className }: NoShiftsAvailableCardProps) => {
    ...
    return (
        ...
        >
            ...
            <Text className="mt-1 text-center font-proximanova-semibold text-[30px] text-[#1F1F1F]">
                {t("common.noShiftsAvailable")}
            </Text>
            <Text className="mt-2 text-center font-proximanova-regular text-[15px] text-[#8C8C8C]">
                {t("common.noShiftsAvailableDescription")}
            </Text>
        </View>
    );
};

export default NoShiftsAvailableCard;
